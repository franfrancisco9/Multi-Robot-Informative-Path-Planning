...
def run_Informative_Scenario(scenario, scenario_number, final=False):
    informative_path = InformativePathPlanning(scenario, budget=375, d_waypoint_distance=2.5, beta_t = 50)
...
def run_BetaInformativeRRT_Scenario(scenario, scenario_number, final=False):
    rrt_path = BiasBetaRRTPathPlanning(scenario, budget=375, d_waypoint_distance=2.5, beta_t = 1.1)
    Z_pred, std = rrt_path.run()
